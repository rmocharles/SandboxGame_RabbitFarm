...
public partial class FarmUI : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else
        {
            ...
            {
                selectCanvas.transform.GetChild(0).localScale = new Vector3(0.005f + 0.0005f * (mainCamera.GetComponent<CinemachineVirtualCamera>().m_Lens.OrthographicSize - 7), 0.005f + 0.0005f * (mainCamera.GetComponent<CinemachineVirtualCamera>().m_Lens.OrthographicSize - 7), 1);
            }
            //for (int i = 0; i < padResoloution.Length; i++)
            //{
            //    if (i > 1)
        ...
        if (Input.GetKeyDown(KeyCode.Escape))
        {
            ...
            else if (playableDirector.state == PlayState.Playing) return;
    ...
    public void MoveMart(bool isMove)
    {
        ...
        if (isMove)
        {
            ...
            previousOrthographicSize = mainCamera.GetComponent<CinemachineVirtualCamera>().m_Lens.OrthographicSize;
            mainCamera.GetComponent<CinemachineVirtualCamera>().m_Lens.OrthographicSize = 100;
        ...
        else
        {
            ...
            SoundManager.GetInstance().SetBgm(0);
            mainCamera.GetComponent<CinemachineVirtualCamera>().m_Lens.OrthographicSize = 100;
            mainCamera.transform.position = new Vector3(10, -2.5f, -10);
