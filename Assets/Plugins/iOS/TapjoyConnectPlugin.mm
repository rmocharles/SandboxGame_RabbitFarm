...
extern "C" {
	...
	void Tapjoy_SetSubjectToGDPR(bool gdprApplicable)
	{
		if (privacyPolicyInstance != nil) {
			[privacyPolicyInstance setSubjectToGDPR: gdprApplicable];
		}
	}
	...
	{
		if (privacyPolicyInstance != nil) {
			[privacyPolicyInstance setUserConsent: tjCreateNSString(consent)];
		}
	}

	void Tapjoy_SetBelowConsentAge(bool isBelowConsentAge)
	{
		if (privacyPolicyInstance != nil) {
			[privacyPolicyInstance setBelowConsentAge: isBelowConsentAge];
		}
	}
